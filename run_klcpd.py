...
AVAILABLE_DATASET_LIST = ['jumpingmean', 'scalingvariance', 'gmm_v2', 'highdim',
                          'beedance', 'fishkiller', 'hasc', 'yahoo', '1h9t']
...
parser.add_argument('--dataset', type=str, default='1h9t', help='dataset name ')
...
parser.add_argument('--max_iter', type=int, default=20, help='max iteration for training')
